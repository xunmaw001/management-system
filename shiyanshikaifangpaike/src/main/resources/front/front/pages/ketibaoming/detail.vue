	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('ketibaoming', this.ketibaomingId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.ketibaomingPhoto ? this.detail.ketibaomingPhoto.split(",") : [];
				},
