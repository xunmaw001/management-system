    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">老师姓名</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"2rpx 2rpx 2rpx 8rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.laoshiName" type="text" v-model="ruleForm.laoshiName" placeholder="老师姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">老师手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"2rpx 2rpx 2rpx 8rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.laoshiPhone" type="text" v-model="ruleForm.laoshiPhone" placeholder="老师手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">老师身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"2rpx 2rpx 2rpx 8rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.laoshiIdNumber" type="text" v-model="ruleForm.laoshiIdNumber" placeholder="老师身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="laoshiPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">老师头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.laoshiPhoto" :src="baseUrl+ruleForm.laoshiPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                ...
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"2rpx 2rpx 2rpx 8rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.laoshiEmail" type="text" v-model="ruleForm.laoshiEmail" placeholder="电子邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`laoshi`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.laoshiId){
                this.ruleForm.laoshiId = options.laoshiId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.laoshiName)) {
                    this.$utils.msg(`老师姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.laoshiPhone) && (!this.$validate.isMobile(this.ruleForm.laoshiPhone))) {
                    this.$utils.msg(`老师手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.laoshiIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.laoshiIdNumber))) {
                    this.$utils.msg(`老师身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.laoshiPhoto)) {
                    this.$utils.msg(`老师头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.laoshiEmail) && (!this.$validate.isEmail(this.ruleForm.laoshiEmail))) {
                    this.$utils.msg(`电子邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`laoshi`, this.ruleForm);
                } else {
                    await this.$api.add(`laoshi`, this.ruleForm);
                }
