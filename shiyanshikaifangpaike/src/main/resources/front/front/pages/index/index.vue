...
<view class="list-box style8"
    ...
    <view v-if="shiyanshiList.length > 0" @tap="onDetailTap('shiyanshi',shiyanshiList[0].id)"
          class="box box1"
        ...
        <div v-if="true"
             ...
             class="title hide1">{{shiyanshiList[0].shiyanshiName}}</div>
        <image
                ...
                :src="baseUrl+shiyanshiList[0].shiyanshiPhoto">
        </image>
    </view>
    <view class="list-item">
        <view v-if="shiyanshiList.length > 1" @tap="onDetailTap('guodaojia',shiyanshiList[1].id)"
              class="box box2"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{shiyanshiList[1].shiyanshiName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+shiyanshiList[1].shiyanshiPhoto">
            </image>
        </view>
        <view v-if="shiyanshiList.length > 2" @tap="onDetailTap('guodaojia',shiyanshiList[2].id)"
              class="box box3"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{shiyanshiList[2].shiyanshiName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+shiyanshiList[2].shiyanshiPhoto">
            </image>
        </view>
        <view v-if="shiyanshiList.length > 3" @tap="onDetailTap('guodaojia',shiyanshiList[3].id)"
              class="box box4"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{shiyanshiList[3].shiyanshiName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+shiyanshiList[3].shiyanshiPhoto">
            </image>
        </view>
    </view>
    <view class="list-item">
        <view v-if="shiyanshiList.length > 4" @tap="onDetailTap('guodaojia',shiyanshiList[4].id)"
              class="box box5"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{shiyanshiList[4].shiyanshiName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+shiyanshiList[4].shiyanshiPhoto">
            </image>
        </view>
        <view v-if="shiyanshiList.length > 5" @tap="onDetailTap('guodaojia',shiyanshiList[5].id)"
              class="box box6"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{shiyanshiList[5].shiyanshiName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+shiyanshiList[5].shiyanshiPhoto">
            </image>
        </view>
    </view>
</view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('gonggao')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
    ...
    <view @tap="onDetailTap('gonggao',item.id)" v-for="(item,index) in gonggaoList" :key="index" class="list-item"
        ...
        <view
                ...
                class="category hide1" v-html="item.gonggaoContent">
        </view>
        <view
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let shiyanshi = await this.$api.list('shiyanshi', {
                page: 1,
                limit: 6,
                });

            this.shiyanshiList = shiyanshi.data.list
            this.shiyanshiList.forEach(function(item, index) {
