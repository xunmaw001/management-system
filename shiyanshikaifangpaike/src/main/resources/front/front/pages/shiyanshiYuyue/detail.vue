	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.shiyanshiYuyueId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('shiyanshiYuyue', this.shiyanshiYuyueId);
                    this.detail = res.data
					this.detail.shiyanshiYuyueContent = this.detail.shiyanshiYuyueContent.replace("<img","<img  class=\"daxiao\"").replace("src=\"upload/","src=\""+this.$base.url+"upload/");
					// 主图
					this.swiperList = this.detail.shiyanshiYuyuePhoto ? this.detail.shiyanshiYuyuePhoto.split(",") : [];
				},
